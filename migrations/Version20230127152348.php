...
final class Version20230127152348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course_purchases (id INT AUTO_INCREMENT NOT NULL, id_course_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, transaction_date DATETIME NOT NULL, INDEX IDX_28C57152D92975B5 (id_course_id), INDEX IDX_28C5715279F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE courses (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, categories_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, document_root VARCHAR(500) NOT NULL, price NUMERIC(10, 0) NOT NULL, INDEX IDX_A9A55A4C79F37AE5 (id_user_id), INDEX IDX_A9A55A4CA21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publications (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, id_category_id INT DEFAULT NULL, title VARCHAR(500) NOT NULL, content VARCHAR(500) NOT NULL, date_publication DATETIME DEFAULT NULL, INDEX IDX_32783AF479F37AE5 (id_user_id), INDEX IDX_32783AF4A545015 (id_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, rol_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, password VARCHAR(500) NOT NULL, email VARCHAR(500) NOT NULL, register_date DATETIME DEFAULT NULL, INDEX IDX_1483A5E9393FB813 (rol_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE course_purchases ADD CONSTRAINT FK_28C57152D92975B5 FOREIGN KEY (id_course_id) REFERENCES courses (id)');
        $this->addSql('ALTER TABLE course_purchases ADD CONSTRAINT FK_28C5715279F37AE5 FOREIGN KEY (id_user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE courses ADD CONSTRAINT FK_A9A55A4C79F37AE5 FOREIGN KEY (id_user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE courses ADD CONSTRAINT FK_A9A55A4CA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id)');
        $this->addSql('ALTER TABLE publications ADD CONSTRAINT FK_32783AF479F37AE5 FOREIGN KEY (id_user_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9393FB813 FOREIGN KEY (rol_id_id) REFERENCES roles (id)');
    }
