...
final class Version20230127152348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contabilities (id INT AUTO_INCREMENT NOT NULL, sponsor_id INT NOT NULL, bill_date DATETIME NOT NULL, quantity NUMERIC(10, 0) NOT NULL, concept VARCHAR(255) DEFAULT NULL, INDEX IDX_45BA02BDDFAEDE6C (sponsor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publications (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, category_id INT DEFAULT NULL, title VARCHAR(500) NOT NULL, content VARCHAR(500) NOT NULL, date_publication DATETIME DEFAULT NULL, INDEX IDX_32783AF479F37AE5 (user_id), INDEX IDX_32783AF4A545015 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contabilities ADD CONSTRAINT FK_45BA02BDDFAEDE6C FOREIGN KEY (sponsor_id) REFERENCES sponsors (id)');
        ...
        $this->addSql('ALTER TABLE publications ADD CONSTRAINT FK_32783AF4A545015 FOREIGN KEY (category_id) REFERENCES categories (id)');
